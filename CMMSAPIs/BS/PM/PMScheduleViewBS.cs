...
namespace CMMSAPIs.BS.PM
{
    ...
    {
        Task<List<CMPMTaskList>> GetPMTaskList(string facility_id, DateTime? start_date, DateTime? end_date, string frequencyIds, string categoryIds, int userID, int self_view, string facilitytime);
    ...
    public class PMScheduleViewBS : IPMScheduleViewBS
    {
        ...
        public async Task<List<CMPMTaskList>> GetPMTaskList(string facility_id, DateTime? start_date, DateTime? end_date, string frequencyIds, string categoryIds, int userID, int self_view, string facilitytime)
        {
            try
            {
