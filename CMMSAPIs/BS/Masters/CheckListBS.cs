...
namespace CMMSAPIs.BS.Masters
{
    public interface ICheckListBS
    {
        ...
        Task<List<CMCheckPointList>> GetCheckPointList(int checklist_id, int facility_Id);
    ...
    public class CheckListBS : ICheckListBS
    {
        ...
        public async Task<List<CMCheckPointList>> GetCheckPointList(int checklist_id,int facility_id)
        {
            try
            {
                using (var repos = new CheckListRepository(getDB))
                {
                    return await repos.GetCheckPointList(checklist_id, facility_id);
