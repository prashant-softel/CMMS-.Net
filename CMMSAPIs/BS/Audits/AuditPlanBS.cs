...
namespace CMMSAPIs.BS.Audits
{
    public interface IAuditPlanBS
    {
        ...
        Task<CMDefaultResponse> DeleteAuditPlan(int audit_plan_id, string facilitytimeZone);
        ...
        Task<CMDefaultResponse> ApprovePlan(CMApproval request, int userId, string facilitytimeZone);
    ...
    public class AuditPlanBS : IAuditPlanBS
    {
        ...
        public async Task<CMDefaultResponse> DeleteAuditPlan(int audit_plan_id, string facilitytimeZone)
        {
            try
            {
                using (var repos = new AuditPlanRepository(getDB))
                {
                    return await repos.DeleteAuditPlan(audit_plan_id, facilitytimeZone);
