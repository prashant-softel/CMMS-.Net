...
namespace CMMSAPIs.BS.Audits
{
    public interface IAuditPlanBS
    {
        ...
        Task<CMDefaultResponse> CreateSubTaskForChecklist(CMCreateAuditPlan auditPlanList, int userID);
    }
    public class AuditPlanBS : IAuditPlanBS
    {
        ...
        public async Task<CMDefaultResponse> CreateSubTaskForChecklist(CMCreateAuditPlan auditPlanList, int userID)
        {
            try
            {
                using (var repos = new AuditPlanRepository(getDB))
                {
                    return await repos.CreateSubTaskForChecklist(auditPlanList, userID);
