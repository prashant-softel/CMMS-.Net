...
namespace CMMSAPIs.Controllers.Users
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> GetUserByNotificationId(string user_ids, int notification_id, int facility_id)
        {
            try
            {
                var data = await _userAccessBs.GetUserByNotificationId(user_ids, notification_id, facility_id);
                return Ok(data);
            }
            catch (Exception ex)
            {
