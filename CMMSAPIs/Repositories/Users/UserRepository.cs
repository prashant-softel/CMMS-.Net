...
namespace CMMSAPIs.Repositories.Users
{
    public class UserAccessRepository : GenericRepository
    {
        ...
        internal async Task<List<CMUser>> GetUserByNotificationId(string user_ids_str,int notification_id, int facility_id)
        {
