    ...
    public class InventoryRepository : GenericRepository
    {
        ...
        internal async Task<CMViewInventory> GetInventoryDetails(int id,string facilitytimeZone)
        {
           ...
           */
            ...
            string myQuery = "SELECT a.id ,a.name, a.description as asset_description,a.calibrationDueDate as calibrationDueDate ,a.calibrationLastDate as calibrationLastDate,a.vendorId as vendorid,a.stockCount as stockCount,a.photoId as photoId,a.retirementStatus as retirementStatus,w.meter_limit as meter_limit,w.meter_unit as meter_unit,a.moduleQuantity, ast.id as typeId, ast.name as type, b2.id as supplierId, b2.name as supplierName, manufacturertlb.id as manufacturerId, manufacturertlb.name as manufacturerName, b5.id as operatorId, b5.name as operatorName, ac.id as categoryId, ac.name as categoryName, a.serialNumber,a.cost as cost,a.currency as currency,a.model,a.calibrationFrequency,frequency.name as calibrationFreqType, a.calibrationReminderDays, " +
