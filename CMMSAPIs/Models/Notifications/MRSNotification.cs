...
namespace CMMSAPIs.Models.Notifications
{
    public class MRSNotification : CMMSNotification
    {
        ...
        {
            return $"{m_baseURL}/mrs-details/{m_module_ref_id}/0";
        }
        ...
        override protected string getEMSubject(params object[] args)
        {
            ...
            switch (m_notificationID)
            {
                ...
                case CMMS.CMMS_Status.MRS_REQUEST_RETURN:
                    retValue += String.Format("MRS{0} Return By {1}", m_MRSObj.ID, m_MRSObj.issue_approved_by_name);
                    break;
        ...
        override protected string getSubject(params object[] args)
        {
            ...
            switch (m_notificationID)
            {
                ...
                case CMMS.CMMS_Status.MRS_REQUEST_ISSUED_REJECTED:
                    ...
                    break;
                case CMMS.CMMS_Status.MRS_REQUEST_ISSUED_APPROVED:
                    retValue = String.Format("{0} MRS{1} Issue Approved By {2}", m_MRSObj.facilityName, m_MRSObj.ID, m_MRSObj.issue_approved_by_name);
                    break;
                case CMMS.CMMS_Status.MRS_REQUEST_RETURN:
                    retValue = String.Format("{0} MRS{1} Return By {2}", m_MRSObj.facilityName, m_MRSObj.ID, m_MRSObj.issue_approved_by_name);
                    break;
        ...
        override protected string getHTMLBody(params object[] args)
        {
            ...
            {
                retValue += String.Format(template, "Issue Approved  By", m_MRSObj.issue_approved_by_name + " at " + m_MRSObj.issue_approved_date);
            }
            ...
            switch (m_notificationID)
            {
                ...
                case CMMS.CMMS_Status.MRS_REQUEST_ISSUED_REJECTED:
                    ...
                    break;
                case CMMS.CMMS_Status.MRS_REQUEST_ISSUED_APPROVED:
                    retValue += String.Format(templateEnd, "Issue Approved By", m_MRSObj.issue_approved_by_name);
                    break;
                case CMMS.CMMS_Status.MRS_REQUEST_RETURN:
                    retValue += String.Format(templateEnd, "Issue Approved By", m_MRSObj.issue_approved_by_name);
                    break;
