...
{
    public class SMMasterNotification
    {
        int m_incidentReportId;
        CMViewIncidentReport m_IncidentReportObj;
        public SMMasterNotification(CMMS.CMMS_Modules moduleID, CMMS.CMMS_Status notificationID, CMViewIncidentReport incidentReportObj) : base(moduleID, notificationID)
        {
