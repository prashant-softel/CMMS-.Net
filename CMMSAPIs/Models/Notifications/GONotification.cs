    ...
    public class GONotification : CMMSNotification
    {
        ...
        override protected string getHTMLBody(params object[] args)
        {
            ...
            if (!string.IsNullOrEmpty(m_GOObj.receive_submitted_by_name) ||
                !string.IsNullOrEmpty(m_GOObj.receive_rejected_by_name) ||
                !string.IsNullOrEmpty(m_GOObj.receive_approved_by_name) ||
                !string.IsNullOrEmpty(m_GOObj.closed_by_name))
            {
            ...
            else if (!string.IsNullOrEmpty(m_GOObj.submitted_by_name) ||
                     !string.IsNullOrEmpty(m_GOObj.approved_by_name) ||
                     !string.IsNullOrEmpty(m_GOObj.rejected_by_name))
            {
