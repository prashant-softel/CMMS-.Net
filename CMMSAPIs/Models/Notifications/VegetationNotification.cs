...
{
    internal class VegitationNotification : CMMSNotification
    {
        int VegId;
        CMMCPlan planObj;
        ...
        public VegitationNotification(CMMS.CMMS_Modules moduleID, CMMS.CMMS_Status notificationID, CMMCPlan vegPlanObj, CMMCExecution vegTaskObj) : base(moduleID, notificationID)
        {
            planObj = vegPlanObj;
